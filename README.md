...
Clean output - Just the path, nothing else

Directory formatting - Automatically adds trailing / for directories
...
Error handling - Shows clear error if path doesn't exist
